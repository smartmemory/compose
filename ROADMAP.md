...
| 182 | COMP-TEST-BOOTSTRAP-4-1 | Review lens for auto-generated tests ('verify assertions match intent') — requires a post-coverage test-review pass (lens cannot fire in the current execute→review→coverage order). | PLANNED |
