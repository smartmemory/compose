...
| 16 | COMP-COMPLETION-GATE-1 | record_completion ledgers the guard transition before the writer rejects a short commit_sha, leaving an unrecoverable intent; validate the full-SHA rule before the guard. | PLANNED |
