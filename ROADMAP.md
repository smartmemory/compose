...
| 131 | COMP-TUI-4 | Parallel task grid: live 2-4 row grid during `parallel_dispatch` showing per-task status (spinner/done/failed) with agent and elapsed time. | IN_PROGRESS |
