...
|------|---------|-----|--------|
| COMP-UX-3 | **Inline gate resolution on Dashboard** | Gates are THE interaction; resolve without switching tabs | Small |
| COMP-UX-4 | **Artifact revision diff** | Show what changed between gate revisions; makes review meaningful | Medium |
| COMP-UX-5 | **Phase transition animations** | Visual confirmation of progress; polish | Small |
...
| COMP-UX-7 | **Live metrics on agent cards** | Kangentic | Medium |
| COMP-UX-9 | **Iteration progress strip** | idea_tiered_evaluation | Medium |
