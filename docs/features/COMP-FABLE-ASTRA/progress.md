...
| 2026-09-10 | **RELEASED** (owner chose patch): stratum 0.5.2 @813d799 tag v0.5.2 (tarball: surface 20, 0 signer keys); compose 0.5.1 + compose-mcp 0.5.1 @2e2f58f tags v0.5.1 / compose-mcp-v0.5.1; both repos pushed with tags. Owner HELD slice 6 live-fire. Falsifiers: `npm view @smartmemory/{stratum,compose,compose-mcp} version` = 0.5.2 / 0.5.1 / 0.5.1. | npm |
