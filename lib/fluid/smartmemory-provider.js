...
export class SmartMemoryFluidProvider extends FluidProvider {
  ...
  capabilities() {
    return new Set([
      ...
      CAP.RECALL, CAP.CHALLENGE, CAP.CONVICTION,
    ]);
  }
  ...
  async resolveConflict(sourceHandle, targetHandle, opts = {}) {
    ...
    return this._withLease('resolveConflict', async () => {
      ...
      try {
        ...
        return this._reconcileResolution(targetHandle, targetId, pre, expectedFact);
      }
