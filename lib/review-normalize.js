...
export async function normalizeCrossModelResult(rawText, {
  ...
  // Step 2 fallback: preserve claude+codex fallback arrays
  ...
  if (!parsed || typeof parsed !== 'object') {
    ...
    consensusRaw   = Array.isArray(parsed.consensus)   ? parsed.consensus   : [];
    claudeOnlyRaw  = Array.isArray(parsed.claude_only)  ? parsed.claude_only  : claudeFindingsFallback;
    codexOnlyRaw   = Array.isArray(parsed.codex_only)   ? parsed.codex_only   : codexFindingsFallback;
  }
