...
export class GitHubProvider extends TrackerProvider {
  ...
  async putFeature(code, obj, _opts = {}) {
    // _opts (write-time validation flags) accepted for interface parity with
    // LocalFileProvider; GitHub persistence has no local schema-guard step.
    return this._lock(code, async () => {
