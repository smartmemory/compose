...
export async function defaultForgejoWrite(link, statePlan, labelsPlan, opts = {}) {
  const outcome = { statePushed: false, labelsPushed: false, errors: [] };
 ...
 * @param {(link: object, statePlan: object, labelsPlan: object) => Promise<{statePushed: boolean, labelsPushed: boolean, errors: string[]}>} [opts.forgejoWrite]
    ...
    for (const link of fj.links) {
      ...
      if (link.provider === 'github' || link.provider === 'forgejo') {
        ...
        if (link.provider === 'github') {
          ...
          pushed.push(forgejoRow(fj, link, statePlan, labelsPlan, outcome));
        }
...
function forgejoRow(fj, link, statePlan, labelsPlan, outcome) {
  const row = {
    code: fj.code,
    provider: 'forgejo',
