 ...
 */
function warnIfSiblingShadowed(kind, installedPackageJsonPath, siblingPackageJsonPath, warn) {
  ...
  warn(
    `[stratum-engine] using installed @smartmemory/stratum ${installedVersion}; `
      ...
      + `Set COMPOSE_STRATUM_TS_MCP_BIN to run a rebuilt checkout (dist/mcp/main.js).`,
  );
}
